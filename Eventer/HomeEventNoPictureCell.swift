...
class HomeEventNoPictureCell: UITableViewCell {
...
//        ]
        ...
        let V_Constraint0 = NSLayoutConstraint.constraintsWithVisualFormat("V:|[evView]-15@999-[timeloc(<=100@999)]-5-[evDescription(<=550@999)]-10-[noOfGoing]-5-[likeButton(60)]|", options: [], metrics: nil, views: views)
