...
class LikeNFTableViewCell: UITableViewCell {
    
    
    var profilePicture:EImageView = EImageView()
    var likeLabel:TTTAttributedLabel = TTTAttributedLabel(frame: CGRectZero)
    
    var eventPicture:EImageView = EImageView()
    var dateLabel:UILabel = UILabel()
    var username:NSString!
    var textFont = UIFont(name: "Lato-Regular", size: 14)
    //var likeLabel:UILabel = UILabel(frame: CGRectMake(50, 5, 220, 30))
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        //likeLabel.font = UIFont(name: "Lato-Regular", size: 14)
        ...
        let H_Constraint1 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-10-[profilePicture(40)]-10-[likeLabel]-10-[dateLabel(49)]-8-|", options: [], metrics: nil, views: views)
        ...
        let V_Constraint1 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-5-[likeLabel(>=0)]-5@999-[brdr(0.5)]|", options: [], metrics: nil, views: views)
        ...
        self.likeLabel.activeLinkAttributes = attrs
        
        self.contentView.setNeedsLayout()
        self.contentView.layoutIfNeeded()
        self.likeLabel.preferredMaxLayoutWidth = self.likeLabel.frame.size.width
        self.eventPicture.frame = self.dateLabel.frame
    }
    ...
    func highlightMentionsInString(text:NSMutableAttributedString, withColor:UIColor){
        ...
        for match:NSTextCheckingResult in matches {
            ...
            self.likeLabel.addLinkToURL(url, withRange: linkRange)
