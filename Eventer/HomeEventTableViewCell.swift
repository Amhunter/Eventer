...
//        ]
        ...
        let H_Constraint4 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-10-[noOfGoing]-20-[noOfLikes]-20-[noOfComments]-20-[noOfShares]->=5@999-|", options: [NSLayoutFormatOptions.AlignAllBaseline, NSLayoutFormatOptions.AlignAllCenterY], metrics: nil, views: views)
        let H_Constraint5 = NSLayoutConstraint.constraintsWithVisualFormat("H:|[goButton(==likeButton)][likeButton(==shareButton)][shareButton(==moreButton)][moreButton(==goButton)]|", options: [NSLayoutFormatOptions.AlignAllBaseline, NSLayoutFormatOptions.AlignAllCenterY], metrics: nil, views: views)


        let V_Constraint0 = NSLayoutConstraint.constraintsWithVisualFormat("V:|[evPicture]-15@999-[timeloc(<=100@999)]-5-[evDescription(<=550@999)]-10-[noOfGoing]-5-[likeButton(60)]|", options: [], metrics: nil, views: views)
